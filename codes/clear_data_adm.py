...
plot_acc(X_train_scaled, X_test_scaled, y_train, y_test, list(range(1, 203, 2)), 'images/knn_neigh_norm_adm.svg')
...
plot_acc(X_train, X_test, y_train, y_test, list(range(1, 203, 2)), 'images/knn_neigh_adm_no_var07.svg')

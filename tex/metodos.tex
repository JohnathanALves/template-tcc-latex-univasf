...
apenas as resultantes da etapa de seleção de variáveis realizada por Ramos. O
Quadro \ref{variablesDescritionTable} descreve essas variáveis e relaciona as
mesmas com os construtos da TDT e seus identificadores.
...
fora do período (já que essas disciplinas poderiam enviesar os modelos de
classificação).

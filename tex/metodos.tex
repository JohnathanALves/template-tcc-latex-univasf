...
\begin{quadro}[!htb]
  ...
  \begin{tabular}{|l|r|r|r|r|}
    \hline
    \multicolumn{1}{|c|}{\textbf{Curso}} & \multicolumn{1}{c|}{\textbf{Alunos}} & \multicolumn{1}{c|}{\textbf{Disciplinas}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Período \\ Inicial\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Período \\ Final\end{tabular}}} \\ \hline
    \begin{tabular}[c]{@{}l@{}}Bacharelado em \\ Administração Pública\end{tabular} & 285 & 41 & 2013.2 & 2017.1 \\ \hline
    Licenciatura em Pedagogia & 160 & 39 & 2014.2 & 2018.1 \\ \hline
  \end{tabular}
\end{quadro}

...
Treinamento: utilizando o conjunto de treinamento e por meio das funções e
...
Avaliação: utilizando o modelo resultante da etapa de treinamento e o conjunto
de teste avaliamos o classificador segundo as seguintes métricas: acurácia,
precisão, sensibilidade, especificidade.

Importância de variáveis: de posse do modelo treinado, avaliamos quais variáveis
tiveram mais influencia na performance do modelo através da classe

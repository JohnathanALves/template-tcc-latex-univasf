...
\begin{figure}[!htb]
  ...
  \subcaptionbox{Dados não normalizados.}{\includegraphics[scale=.45]{img/knn_neigh_ped}}\qquad
...
\begin{figure}[!htb]
  ...
  \subcaptionbox{Dados não normalizados.}{\includegraphics[scale=.45]{img/knn_neigh_adm}}\qquad

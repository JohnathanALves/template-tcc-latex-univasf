...
\begin{figure}[!htb]
  ...
  \subcaptionbox{\label{knnKResultsPedA}Dados não normalizados.}{\includegraphics[scale=.45]{img/knn_neigh_ped}}\qquad
  \subcaptionbox{Dados normalizados.}{\includegraphics[scale=.45]{img/knn_neigh_norm_ped}}
  \vspace{1.5em}
  \Ididthis
\end{figure}
...
\begin{figure}[!htb]
  ...
  \subcaptionbox{\label{knnKResultsAdmA}Dados não normalizados.}{\includegraphics[scale=.45]{img/knn_neigh_adm}}\qquad
  \subcaptionbox{Dados normalizados.}{\includegraphics[scale=.45]{img/knn_neigh_norm_adm}}
  \vspace{1.5em}
  \Ididthis
\end{figure}
...
\begin{figure}[!htb]
  ...
  \subcaptionbox{KNN Administração.}{\includegraphics[scale=.40]{img/cm_knn_adm}}\qquad
  \subcaptionbox{LR Administração.}{\includegraphics[scale=.40]{img/cm_rl_adm}}\qquad
  \subcaptionbox{Árvore de Decisçao Administração.}{\includegraphics[scale=.40]{img/cm_tree_adm}}
  \subcaptionbox{KNN Pedagogia.}{\includegraphics[scale=.40]{img/cm_knn_ped}}\qquad
  \subcaptionbox{LR Pedagogia.}{\includegraphics[scale=.40]{img/cm_rl_ped}}\qquad
  \subcaptionbox{Árvore de Decisçao Pedagogia.}{\includegraphics[scale=.40]{img/cm_tree_ped}}
  \vspace{1.5em}
  \Ididthis
\end{figure}

trAs matrizes de confusão serviram como base para o cálculo das métricas dos
...
repositório de código aberto junto com o texto deste trabalho disponível em
https://github.com/esron/template-tcc-latex-univasf.

...
\begin{figure}[!htb]
  ...
  \subcaptionbox{Árvore de Descisão Administração.}{\includegraphics[scale=.40]{img/cm_tree_adm}}
  ...
  \subcaptionbox{Árvore de Descisão Pedagogia.}{\includegraphics[scale=.40]{img/cm_tree_ped}}
  \vspace{1.5em}
  \Ididthis
\end{figure}

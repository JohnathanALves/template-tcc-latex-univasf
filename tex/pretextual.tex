...
\begin{resumo}
  ...
  \textbf{Palavras-chave}: Ciência de Dados. Aprendizagem Supervisionada. Evasão. Descoberta de Conhecimentos em Bases de Dados
...
\begin{otherlanguage*}{english}
  ...
  algorithms: KNN, Logistic Regression and Decision Tree. In the construction
  of the models, we used data obtained from two classes in the context of the
  ...
  sources of data from the classifiers, reaching values ​​similar to the

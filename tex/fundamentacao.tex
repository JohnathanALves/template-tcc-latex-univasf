...
Em seus estudos, \citeauthoronline{moore1973transational} (2013) afirmou que na
EAD não existe apenas uma distância física entre professores e alunos, mas,
também, uma distância psicológica. Na TDT, as interações do estudante, com o
professor, com o conteúdo e com os estudantes, podem ser estudadas com base em
construtos elementares, sendo eles, a estrutura dos programas ou cursos, o
diálogo entre alunos e professores e o grau de autonomia do discente. De acordo
com a TDT a EAD tem a sua própria identidade e características pedagógicas
distintivas. Como outras teorias, a TDT pode ser usada no estabelecimento de uma
heurística, para a tomada de decisões em projetos de cursos EAD
(\citeauthor{moore1973transational}, 2013).
...
\citeauthoronline{moore1973transational} (2013), essa separação cria padrões
especiais de comportamento que afetam tanto o ensino quanto o aprendizado.
Derivado da separação, surge um espaço psicológico e comunicacional propício a
...
(2013) a distância transacional não é um valor fixo ou dicotômico, na verdade, é
um valor relativo e contínuo. Além disso, essa distância é diferente para cada
...
\citeauthoronline{moore1973transational} (2013) como sendo interações focadas,
...
\citeauthoronline{moore1973transational} (2013) cita meios de comunicação como
um importante fator ambiental na EAD, no entanto, relata ser importante que
outras variáveis sejam atendidas à medida que a EAD amadurece, as variáveis
destacadas por Moore foram: projeto de curso, seleção e treinamento de
instrutores e o estilo de aprendizagem dos alunos.
...
instituições educacionais (\citeauthor{moore1973transational}, 2013).
...
transacional que outro'' (\citeauthor{moore1973transational}, 2013).
...
autonomia do aluno (\citeauthor{moore1973transational}, 2013).
...
processos de aprendizagem'' (\citeauthor{moore1973transational}, 2013).
...
\citeauthoronline{moore1973transational} (2013) definiu o estudante autônomo
ideal como ``a pessoa emocionalmente independente de um professor'' e quem ``tem
capacidade de abordar o assunto estudado diretamente sem a ajuda de um
instrutor''. Diferente da estrutura do curso e do diálogo, é um fator que
depende apenas do aluno. Um aprendiz pouco autônomo pode precisar de um
direcionamento maior e uma estrutura mais rígida \cite{huang2016understanding}.
...
\citeauthoronline{moore1973transational} (2013), outros autores afirmaram que
quanto maior for a DT, maior a possibilidade de ocorrência de problemas como
...
ilustra uma visão geral do KDD segundo \citeonline{tan2009introduccao}.
...
ambientes nos quais eles interagem, tais como Ambientes Virtuais de Aprendizagem
(AVA), Sistemas Tutores Inteligentes, entre outros.
...
analíticas de aprendizagem (LA, do inglês, \textit{Learning Analytics}),
